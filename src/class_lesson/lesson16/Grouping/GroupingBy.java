...
public class GroupingBy {
    public static void main(String[] args) {
        ...
        Map<String, List<Telephone>> phonesByCompany = phoneStream.collect(
                Collectors.groupingBy(Telephone::getModel)
        );

        for (Map.Entry<String, List<Telephone>> item : phonesByCompany.entrySet()) {
